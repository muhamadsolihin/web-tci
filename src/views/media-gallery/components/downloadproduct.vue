    ...
    <div class="row">
        ...
        <div class="card bg-transparent">
          <div class="image-wrapper" style="margin-left: -1em">
            <img
              ...
              src="@/assets/images/media-gallery/rbi.png"
              alt="..."
            />
          </div>
          <div class="card-body">
      ...
      <div class="col-6 mt-5" style="margin-bottom: 2em">
        <div class="card bg-transparent">
          <div class="image-wrapper" style="margin-left: -1em">
            <img
              style="width: 182px; height: 256px"
              src="@/assets/images/media-gallery/makasi.png"
              alt="..."
            />
          </div>
          <div class="card-body">
      ...
      <div class="col-6 mt-5" style="margin-bottom: 2em">
        <div class="card bg-transparent">
          <div class="image-wrapper" style="margin-left: -1em">
            <img
              style="width: 182px; height: 156px"
              src="@/assets/images/media-gallery/ic-datacompany.png"
              alt="..."
            />
          </div>
