                  ...
                  <div class="card bg-transparent">
                    ...
                    <div class="card-body">
                      <a
                        ...
                        style="float: center; margin-left: 21%"
                        >{{ index.title }}E-Brochure IT Solutions</a
                      >
                    </div>
                  </div>
                  <div class="card">
                    <div class="image-wrapper">
                      <img src="@/assets/images/media-gallery/arthology.png" alt="..." />
                    </div>
                    <div class="card-body">
                      <a
                        href="#"
                        class="btn btn-primary"
                        style="float: center; margin-left: 24%"
                        > E-Brochure Arthology </a
                      >
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <div class="card-body">
                      <a
                        ...
                        >{{ index.title1 }}E-Brochure ICDATA</a
                      >
                    </div>
                  </div>
                </div>
